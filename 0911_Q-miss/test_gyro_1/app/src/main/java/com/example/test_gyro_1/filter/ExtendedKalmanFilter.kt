...
class ExtendedKalmanFilter {
    ...
    private val accelNoiseStdDev = 0.5f //加速度ノイズの標準偏差 (m/s^2) bf0.5
    ...
    private val SHORT_DISTANCE_THRESHOLD = 1.5f //m(これ未満のGPS移動ではGPS更新を抑制) bf2
    ...
    private val GPS_XY_NOISE_FACTOR = 0.25f //bf0.5
