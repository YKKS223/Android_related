...
data class MotionState(
    ...
    val angleYaw: Float = 0f,   //Z軸周り (方位角)
    val anglePitch: Float = 0f, //X軸周り (傾き 前後)
    val angleRoll: Float = 0f,  //Y軸周り (傾き 左右)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (pathHistory != other.pathHistory) return false //比較追加
    ...
    override fun hashCode(): Int {
        ...
        result = 31 * result + pathHistory.hashCode() //追加
